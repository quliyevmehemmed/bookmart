...
<div id="mobileMenuSidebar" class="fixed top-0 left-0 h-full w-[300px] bg-white z-50 transform -translate-x-full transition-transform duration-300 overflow-y-auto flex flex-col">
    ...
    <div class="p-4 border-b border-gray-100 flex items-center justify-between">
        <div class="relative w-full mr-2">
            <input type="text" placeholder="Axtar ..." class="w-full bg-transparent text-sm text-gray-700 py-2 focus:outline-none placeholder-gray-500">
            <button class="absolute right-0 top-1/2 -translate-y-1/2 text-gray-500">
