@php
    ...
    $inWishlist = in_array($book->id, $wishlist, true);
@endphp
...
<div x-data="{ isHovered: false }"
    ...
    <div class="bg-white transition-all duration-[350ms] ease-in-out flex flex-col overflow-hidden"
        ...
        <div x-show="isHovered"
            ...
            <div class="flex items-center justify-between mt-auto z-20" @click.stop>
                ...
                <button class="bg-[#2D2A5E] text-white px-4 py-2 text-[10px] font-bold tracking-tighter hover:bg-black transition-colors rounded relative z-30">
                    SƏBƏTƏ AT
                </button>
